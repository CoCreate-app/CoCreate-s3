...
const CoCreate = {
  ...
  initSocketListener: function() {
    ...
    CoCreate.socket.listen('deletedDocument', function(data) {
      console.log(data);
    })
    ...
    this.listenMessage('downloadFileInfo', function(data) {
      CoCreate.socket.saveFileName = data.file_name;
    })
  ...
  createGeneralSocket: function(host, namespace) {
    if (namespace) {
    	...
    	CoCreate.socket.setGlobalScope(namespace);
    } else {
    	CoCreate.socket.create({
    	  namespace: null, 
    	  room: null,
  ...
  */
  ...
  readDocumentList(info){
    ...
    CoCreate.socket.send('readDocumentList', request_data);
  },
  ...
  */
  createDocument: function(info) {
    ...
    CoCreate.socket.send('createDocument', request_data, room);
  },
  ...
  */
  updateDocument: function(info) {
    ...
    const room = this.generateSocketClient(info.namespace, info.room);
    CoCreate.socket.send('updateDocument', request_data, room);
  },
  ...
  */
  readDocument: function(info) {
    ...
    request_data['metadata'] = info['metadata']
    CoCreate.socket.send('readDocument', request_data);
  },
  ...
  */
  deleteDocument: function(info) {
    ...
    const room = this.generateSocketClient(info.namespace, info.room);
    CoCreate.socket.send('deleteDocument', request_data, room);
  },
 ...
 */
 sendMessage: function(data) {
    ...
    CoCreate.socket.send('sendMessage', request_data, room)
 },
 
 listenMessage: function(message, fun) {
   CoCreate.socket.listen(message, fun);
 },
 
 createSocket: function(config) {
   CoCreate.socket.create(config);
 },
 ...
 */
 destroySocket: function(config) {
   ...
   const key = CoCreate.socket.getKey(namespace, room);
   let socket = CoCreate.socket.sockets.get(key);
   
   if (!socket) {
     return
   }
   CoCreate.socket.destroy(socket, key);
 },
  ...
  */
  exportCollection: function(info) {
    ...
    request_data['metadata'] = info['metadata']
    CoCreate.socket.send('exportDB', request_data);
  },
  ...
  */
  importCollection: function(info) {
    ...
    CoCreate.socket.send('importDB', request_data)
    CoCreate.socket.sendFile(file);
  }
}
