# Contributing to CoCreate-s3

This project is work of [many contributors](https://github.com/CoCreate-app/CoCreate-s3/graphs/contributors).
You're encouraged to submit [pull requests](https://github.com/CoCreate-app/CoCreate-s3/pulls),
[propose features and discuss issues](https://github.com/CoCreate-app/CoCreate-s3/issues).

In the examples below, substitute your Github username for `contributor` in URLs.

## Fork the Project

Fork the [project on Github](https://github.com/CoCreate-app/CoCreate-s3) and check out your copy.

```
git s3 https://github.com/contributor/CoCreate-s3.git
cd CoCreate-s3
git remote add upstream https://github.com/CoCreate-app/CoCreate-s3.git
```
...
Go to [https://github.com/CoCreate-app/CoCreate-s3](https://github.com/CoCreate-app/CoCreate-s3) and select your feature branch.
